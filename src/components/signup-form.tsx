      ...
      <div className="max-w-md w-full space-y-8">
        ...
        <div className="text-center">
          ...
          >
            ...
            <span className="text-2xl font-bold text-gray-900">AI Notes</span>
          </Link>
          ...
          <CardContent className="space-y-4">
            <form className="space-y-4" action={action}>
              ...
              <Button
                disabled={isPending}
                type="submit"
                className="w-full cursor-pointer cursor-pointer h-11 bg-gradient-to-r from-blue-600 to-purple-600 hover:from-blue-700 hover:to-purple-700 text-white disabled:opacity-50"
              >
                Create account
              </Button>
            </form>
